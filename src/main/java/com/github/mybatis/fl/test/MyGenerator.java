...
public class MyGenerator {
	...
	public static final String URL = "jdbc:mysql://127.0.0.1:3306/demo01?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=UTC";
	public static final String NAME = "root";
	public static final String PASS = "root";
	public static final String DATABASE = "demo01";
	...
	public static void main(String[] args) {
		...
		try {
			...
			String fileUrl = "/Users/lz/desktop/pj/temple/";// 生成文件存放位置
